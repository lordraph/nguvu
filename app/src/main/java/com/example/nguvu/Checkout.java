...
public class Checkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOne.setOnClickListener(v -> {
            ...
            Intent activity2Intent = new Intent(getApplicationContext(), Successful.class);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(Checkout.this, SelectPlan.class);
        startActivity(intent);
    }

    public void showDialog(){
        Dialog dialog = new Dialog(Checkout.this);
        dialog.setContentView(R.layout.cancel_plan_dialog);
