...
public class QuestionSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOne.setOnClickListener(v -> {
            ...
            Intent activity2Intent = new Intent(getApplicationContext(), QuestionSeven.class);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(QuestionSix.this, QuestionFive.class);
        startActivity(intent);
    }

    public void showDialog(){
        Dialog dialog = new Dialog(QuestionSix.this);
