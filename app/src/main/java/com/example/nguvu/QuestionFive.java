...
public class QuestionFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOne.setOnClickListener(v -> {
            ...
            Intent activity2Intent = new Intent(getApplicationContext(), QuestionSix.class);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(QuestionFive.this, QuestionThree.class);
        startActivity(intent);
    }

    public void showDialog(){
        Dialog dialog = new Dialog(QuestionFive.this);
