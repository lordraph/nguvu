...
public class QuestionEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOne.setOnClickListener(v -> {
            ...
            Intent activity2Intent = new Intent(getApplicationContext(), QuestionNine.class);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(QuestionEight.this, QuestionSeven.class);
        startActivity(intent);
    }

    public void showDialog(){
        Dialog dialog = new Dialog(QuestionEight.this);
