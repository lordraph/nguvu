...
public class QuestionTen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOne.setOnClickListener(v -> {
            ...
            Intent activity2Intent = new Intent(getApplicationContext(), LastQuestion.class);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(QuestionTen.this, QuestionNine.class);
        startActivity(intent);
    }

    public void showDialog(){
        Dialog dialog = new Dialog(QuestionTen.this);
